...
function EditConfigureWatch(props){
    ...
    const handleParticipantChange = async (e, campaign_id) =>{
        try{
            ...
            //manager_id : localStorage.getItem("managerId"),
            campaign_id : campaign_id, //localStorage.getItem("campaignId")
            ...
            <div style={{height:"inherit"}}>
                <Container style={{height:"100%"}}>
                    <Row style={{height:"100%"}}>
                        ...
                        <SideNavbar list={["Campaign List", "Create Campaign","Edit Campaign", "Create Coordinator", "Coordinator Permissions", "Edit Watch Configuration"]} active={5} links={["/managerDashboard","/createCampaign","/editCampaign","/createCoordinator","/coordinatorPermission","/editConfigureWatch"]}/>
                        </Col>
                        <Col style={{height: "75%"}}>
